...
entrada_discretizada = sin(2*pi*500.*n1/Fs) + sin(2*pi*2500.*n1/Fs) + sin(2*pi*5000.*n1/Fs) + sin(2*pi*8000.*n1/Fs);
...
subplot(2,2,3); plot(f_entrada(1:N_sinal_sintetico/2), abs(fft_sinal_entrada(1:N_sinal_sintetico/2)),'r');
hold on;
